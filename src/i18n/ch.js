...
export default {
  ...
  sections: {
    'Election office': {
      ...
      p1: '从 2024 年 8 月 20 日起，费城选举委员会将开放进行面对面的邮寄选票投票。注册选民可以在一次访问中亲自申请、接收、填写和退回邮寄的选票。',
      ...
      dates: {
        ...
        d2:{
          text: '申請郵寄選票的截至日期',
          date: '2024 年 9 月 10 日下午 5:00 之前',
        },
        d3:{
          text: '申請補發選票的截至日期',
          date: '不早于 2024 年 8 月 27 日',
        },
        d4:{
          text: '投递您填好的选票的截至日期',
          date: '2024 年 9 月 17 日晚上 8:00 之前',
        },
      },
    },
